  ...
  return (
    ...
    <div className='header '>
      <Navbar bg="white"  className="navbar fixed-top mx-auto border-bottom">
          ...
          <div className="nav-item dropdown nav-item-box  d-flex align-items-center mr-24">
              ...
              <div className="dropdown-menu  notifications ">
                ...
                <div className="dropdown text-end">
                    <Link to="/" className="flex justify-center items-center font-semibold link-body-emphasis text-decoration-none dropdown-toggle mx-2" data-bs-toggle="dropdown" aria-expanded="false">
