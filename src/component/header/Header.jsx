    ...
    <div className='header'>
      <Navbar bg="white" expand="lg" className="navbar fixed-top ">
        <Container className="p-3 mb-3 border-bottom">
          ...
          <div className="nav-item dropdown nav-item-box  d-flex align-items-center">
                     ...
                     <div className="topnav-dropdown-header">
                      ...
                      <div className="noti-content">
                       ...
                       <div className="topnav-dropdown-footer">
                            <Link className="nav-link" to="/Link pps/notifications">View all Notifications</Link >
                        </div>
              </div>
            
                <div className="dropdown text-end">
                    <Link to="#" className="d-block link-body-emphasis text-decoration-none dropdown-toggle mx-2" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul className="dropdown-menu text-small">
                            <li><Link className="dropdown-item" to="/Link pps/profile">Profile</Link ></li>
